...
public class TestMain2 {
	...
	static TestMain2 test = new TestMain2();
	...
	public static void main(String[] args) {
		...
		infoLine = readInfo.readFileByLines("D:\\macIP20.txt");
		...
		for (int i = 0; i < infoLine.size(); i++) {
			...
			try {
				...
				try {
					...
					// TODO Auto-generated catch block
					// 写入到异常文件
					writeFile("D:\\exceRresultIP18.txt", ip  + "\t" + resultInfo + "\r\n");
					e1.printStackTrace();
			...
			writeFile("D:\\succeRresultIP20.txt", ip + "\t" + resultInfo + "\r\n");// succeRresultIP
		}
